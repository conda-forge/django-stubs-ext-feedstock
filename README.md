...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-stubs-ext-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12485&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-stubs-ext-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-stubs-ext` can be installed with:

```
conda install django-stubs-ext
```

It is possible to list all of the versions of `django-stubs-ext` available on your platform with:
