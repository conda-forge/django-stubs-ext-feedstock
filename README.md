About django-stubs-ext-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-stubs-ext-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-stubs-ext-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-stubs-ext
# for installing globally
pixi global install django-stubs-ext
```
...
It is possible to list all of the versions of `django-stubs-ext` available on your platform:
...
```
pixi search django-stubs-ext --channel conda-forge
```
